...
| File | What it proves |
|------|----------------|
| `jenkins-ecr-push.png` | CI pushes image to ECR |
| `jenkins-metrics-success.png` | CI runs detector + S3 metrics |
| `jenkins-finished-success.png` | Jenkins pipeline green |
| `ecr-car-detector-tags.png` | Images/tags in ECR |
| `eks-cluster-active.png` | EKS cluster ready |
| `kubectl-get-jobs.png` | Helm Job completed |
| `eks-pod-image-pulled.png` | Pod uses ECR image `:15` |
| `eks-pod-env-irsa.png` | IRSA + S3 env on pod |
| `eks-pod-logs-metrics.png` | Detector logs + S3 upload on EKS |
| `eks-describe-pod-success.png` | Pod succeeded (exit 0) |
